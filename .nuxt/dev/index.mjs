globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join as join$1 } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, getQuery, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/hookable/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/radix3/dist/index.mjs';
import { extname, join } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/unified/index.js';
import { toString } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/mdast-util-to-string/index.js';
import { preprocess } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/micromark/dev/lib/postprocess.js';
import { stringifyPosition } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/micromark-util-resolve-all/index.js';
import remarkEmoji from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/rehype-raw/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/remark-mdc/dist/index.mjs';
import remarkParse from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/remark-rehype/index.js';
import { all } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/detab/index.js';
import { u } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/unist-builder/index.js';
import { encode } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/mdurl/index.js';
import slugify from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/slugify/slugify.js';
import { position } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/unist-util-position/index.js';
import { visit } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/unist-util-visit/index.js';
import { BUNDLED_LANGUAGES, BUNDLED_THEMES, getHighlighter } from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/shiki-es/dist/shiki.node.mjs';
import consola from 'file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/unenv/runtime/npm/consola.mjs';
...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{"content":{"locales":[],"defaultLocale":"","integrity":"","experimental":{"stripQueryParameters":false,"clientDB":false},"api":{"baseURL":"/api/_content"},"navigation":{"fields":[]},"tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"highlight":{"theme":"github-light"},"wsUrl":"ws://localhost:4000/","documentDriven":false,"host":"","trailingSlash":false,"anchorLinks":{"depth":4,"exclude":[1]}}},"content":{"cacheVersion":2,"cacheIntegrity":"7xFaqB29fO","transformers":[],"base":"","api":{"baseURL":"/api/_content"},"watch":{"ws":{"port":{"port":4000,"portRange":[4000,4040]},"hostname":"localhost","showURL":false}},"sources":{},"ignores":["\\.","-"],"locales":[],"defaultLocale":"","highlight":{"theme":"github-light"},"markdown":{"tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"anchorLinks":{"depth":4,"exclude":[1]},"remarkPlugins":{},"rehypePlugins":{}},"yaml":{},"csv":{"delimeter":",","json":true},"navigation":{"fields":[]},"documentDriven":false,"experimental":{"clientDB":false,"stripQueryParameters":false}}};
...
const serverAssets = [{"baseName":"server","dir":"/home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _S8WKmI = defineEventHandler(async (event) => {
...
const _yVgRQx = defineEventHandler(async (event) => {
...
const _yJFdiC = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const handlers = [
  ...
  { route: '/api/_content/query/:qid/**:params', handler: _S8WKmI, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _S8WKmI, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _S8WKmI, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _yVgRQx, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _yJFdiC, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _yJFdiC, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _yJFdiC, lazy: false, middleware: false, method: "get" },
...
const getClientManifest = () => import('/home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/home/matheus-alpe/workspace/personal-projects/vue-mastery-pratices/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
